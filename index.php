   ...
   <div class="app">
     ...
     <div class="navbar navbar-app navbar-absolute-bottom" ng-controller="MainController"><!-- Bottom Navbar -->
       <div class="btn-group justified">
            ...
            <a ng-click="categories()" class="btn btn-navbar btn-icon-only"><i class="fa fa-list fa-navbar"></i></a>
            <a ng-click="settings()" class="btn btn-navbar btn-icon-only"><i class="fa fa-cog fa-navbar"></i></a>
        </div>
     </div>
